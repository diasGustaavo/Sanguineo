...
struct Spinner: View {
    ...
    var body: some View {
        ZStack {
            ZStack {
                // S3
                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS3, color: Color.accentColor, lineWidth: lineWidth)

                // S2
                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS2, color: Color.accentColor, lineWidth: lineWidth)

                // S1
                SpinnerCircle(start: spinnerStart, end: spinnerEndS1, rotation: rotationDegreeS1, color: Color(uiColor: UIColor(named: "interColor")!), lineWidth: lineWidth)
